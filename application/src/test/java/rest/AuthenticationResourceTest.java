...
public class AuthenticationResourceTest {
    ...
    public void login_Success_Verify_Token_Lifetime() throws ParseException {
        ...
        long issueTime = TimeUnit.DAYS.convert(issuedAt.getTime(), TimeUnit.MILLISECONDS);
        long expirationTime = TimeUnit.DAYS.convert(expiration.getTime(), TimeUnit.MILLISECONDS);
